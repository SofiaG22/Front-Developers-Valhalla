      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <motion.div
              key={index}
              initial={reduce ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: 36, rotateX: -8 }}
              ...
              whileHover={reduce ? undefined : { y: -8, transition: { type: "spring", stiffness: 400, damping: 22 } }}
              className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary/50 dark:hover:border-primary/50 shadow-sm hover:shadow-xl transition-shadow duration-300 [perspective:1000px]"
            >
        ...
        <ScrollReveal delay={0.15} className="mt-16 text-center">
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#4F46E5] to-[#7C3AED] text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
          >
